...
package de.paladinsinn.tp.dcis.ui.components.users;
    ...
    public FrontendUser frontendUser() {
        ...
        if (identity == null || jwt == null) {
            ...
            result = FrontendUser.builder()
                    ...
                    .avatar(new AvatarUri("support@paladins-inn.de").buildUrl())
            ...
            result = FrontendUser.builder()
                    ...
                    .avatar(new AvatarUri(jwt.getClaim("email")).buildUrl())
