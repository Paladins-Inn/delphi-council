 ...
 */
public class MissionGroupReportSaveEvent extends ComponentEvent<MissionGroupReportEditForm> {
    /**
     ...
     */
    public MissionGroupReportSaveEvent(MissionGroupReportEditForm source, boolean fromClient) {
