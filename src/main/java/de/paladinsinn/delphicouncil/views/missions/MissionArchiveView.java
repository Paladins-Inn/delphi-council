...
@Route(value = "missions/archived", layout = MainView.class)
@PageTitle("Mission Archive")
@CssImport("./views/missionarchive/mission-archive-view.css")
public class MissionArchiveView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public MissionArchiveView() {
        addClassName("mission-archive-view");
        setSizeFull();
        grid.setHeight("100%");
