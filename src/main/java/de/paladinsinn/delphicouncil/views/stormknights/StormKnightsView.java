...
@Route(value = "storm-knights", layout = MainView.class)
@PageTitle("Storm Knights")
@CssImport("./views/stormknights/storm-knights-view.css")
public class StormKnightsView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public StormKnightsView() {
