...
package de.paladinsinn.tp.dcis.events;
 ...
 */
public class MissionGroupReportSaveEvent extends ComponentEvent<MissionReportForm> {
    /**
     ...
     */
    public MissionGroupReportSaveEvent(MissionReportForm source, boolean fromClient) {
