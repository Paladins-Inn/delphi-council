 ...
 */
@Getter
public class RemoveOperativeFromMissionEvent extends ComponentEvent<TorgForm> {

    /**
     * The operative to be removed.
     */
    private final OperativeReport operativeReport;
     ...
     */
    public RemoveOperativeFromMissionEvent(@NotNull final TorgForm source, @NotNull final OperativeReport report) {
        super(source, false);
    ...
    public String toString() {
        return new StringJoiner(", ", RemoveOperativeFromMissionEvent.class.getSimpleName() + "[", "]")
